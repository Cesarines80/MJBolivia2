...
<head>
    ...
    <meta name="description"
        content="<?php echo htmlspecialchars($config['metadescription'] ?? $config['nombre_institucion']); ?>">
    <meta name="keywords"
        content="<?php echo htmlspecialchars($config['metakeywords'] ?? 'institución, educación, servicios'); ?>">
    ...
    <section id="home" class="hero-carousel">
        <?php if (empty($carrusel)): ?>
            ...
            <div class="carousel-item active">
                <img src="https://via.placeholder.com/1920x600/<?php echo substr($colorPrimario, 1); ?>/ffffff?text=Bienvenidos"
                    alt="Bienvenidos">
                <div class="carousel-caption">
                    <h2>Bienvenidos a <?php echo htmlspecialchars($config['nombre_institucion']); ?></h2>
                    <p><?php echo htmlspecialchars($config['descripcion'] ?? 'Educación de excelencia para el futuro de nuestros estudiantes'); ?>
                    </p>
                </div>
            </div>
        <?php else: ?>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="feature-box">
                        ...
                        <h3><?php echo htmlspecialchars($historia['titulo'] ?? 'Nuestra Historia'); ?></h3>
                        <?php if ($historia['imagen']): ?>
                            <img src="<?php echo UPLOADS_URL . $historia['imagen']; ?>" alt="Historia"
                                class="img-fluid rounded mb-3" style="max-height: 200px; object-fit: cover;">
                        <?php endif; ?>
                        <p><?php echo nl2br(htmlspecialchars($historia['contenido'] ?? 'Historia de nuestra institución')); ?>
                        </p>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <div class="feature-box h-100">
                        ...
                        <?php if ($mision['imagen']): ?>
                            <img src="<?php echo UPLOADS_URL . $mision['imagen']; ?>" alt="Misión"
                                class="img-fluid rounded mb-3" style="max-height: 150px; object-fit: cover;">
                        <?php endif; ?>
                        <p><?php echo nl2br(htmlspecialchars($mision['contenido'] ?? 'Misión de la institución')); ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="feature-box h-100">
                        ...
                        <?php if ($vision['imagen']): ?>
                            <img src="<?php echo UPLOADS_URL . $vision['imagen']; ?>" alt="Visión"
                                class="img-fluid rounded mb-3" style="max-height: 150px; object-fit: cover;">
                        <?php endif; ?>
                        <p><?php echo nl2br(htmlspecialchars($vision['contenido'] ?? 'Visión de la institución')); ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="feature-box h-100">
                        ...
                        <?php if ($valores['imagen']): ?>
                            <img src="<?php echo UPLOADS_URL . $valores['imagen']; ?>" alt="Valores"
                                class="img-fluid rounded mb-3" style="max-height: 150px; object-fit: cover;">
                        <?php endif; ?>
                        <p><?php echo nl2br(htmlspecialchars($valores['contenido'] ?? 'Valores de la institución')); ?>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <?php foreach ($eventos as $evento): ?>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <a href="evento-detalle.php?id=<?php echo $evento['id']; ?>"
                                class="card event-card text-decoration-none">
    ...
    <section id="gallery" class="section">
        <div class="container">
            <div class="section-title">
                ...
                <p>Descubre nuestros álbumes fotográficos con colecciones completas de imágenes</p>
            </div>
            ...
            <?php else: ?>
                <div class="row">
                    <?php foreach ($galeria as $item): ?>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <a href="galeria-detalle.php?id=<?php echo $item['id']; ?>" class="gallery-item">
                                <img src="<?php echo UPLOADS_URL . $item['imagen']; ?>"
                                    alt="<?php echo htmlspecialchars($item['titulo']); ?>">
                                <div class="gallery-overlay">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <?php if ($config['twitter']): ?>
                                    <a href="<?php echo htmlspecialchars($config['twitter']); ?>" target="_blank"
        ...
        <div class="container">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled text-muted">
                        <?php if ($config['direccion']): ?>
                            <li><i
                                    class="fas fa-map-marker-alt me-2"></i><?php echo htmlspecialchars($config['direccion']); ?>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if ($config['email_contacto']): ?>
                            <li><i
                                    class="fas fa-envelope me-2"></i><?php echo htmlspecialchars($config['email_contacto']); ?>
                            </li>
                        <?php endif; ?>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                <p class="mb-0">&copy; <?php echo date('Y'); ?>
                    <?php echo htmlspecialchars($config['nombre_institucion']); ?>. Todos los derechos reservados.</p>
            </div>
        </div>
    </footer>
